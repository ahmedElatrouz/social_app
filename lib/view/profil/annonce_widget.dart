      ...
      child: Column(
        children: <Widget>[
            ...
            children: <Widget>[
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: widget.annonce.date != null
                        ? Text(
                            widget.annonce.date.day.toString() +
                                '/' +
                                widget.annonce.date.month.toString() +
                                '/' +
                                widget.annonce.date.year.toString(),
          ...
          Container(
              ...
              child: widget.annonce.description != null
